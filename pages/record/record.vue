	...
	<view class="login">
		...
		<!-- 	<view class="header">
			...
			<wButton  
				...
				@click="startLogin"
			></wButton>
			<button v-if="apple" class="applelogin" @click="appLogin()"><image src="../../static/pg.png" class="pg"></image>Sign in with Apple</button>
			<view class="other_login cuIcon">
				<view class="login_icon">
					<view class="cuIcon-weixin" @tap="login_weixin" style="font-size: 100rpx; color: #81D842;"></view>
					<text style="font-size: 15rpx;font-weight: 800;">微信登录</text>
				</view>
			</view>
			<!-- <wButton  
				class="wbutton"
			...
			<!-- <view class="other_login cuIcon">
				...
				<view class="login_icon">
					<view class="cuIcon-weibo" @tap="login_weibo" style="font-size: 60rpx;"></view>
				</view>
				<view class="login_icon">
					<view class="cuIcon-github" @tap="login_github" style="font-size: 60rpx;"></view>
				</view>
			</view> -->
			...
			<view class="footer">
				...
				<text>|</text>
				<navigator url="../register/register" open-type="navigate">注册登录</navigator>
			</view>
		</view>
	</view>
</template>
